...
#### Замените <имя_сервиса> на соответствующее имя сервиса (например, web или app), а <имя_фикстуры> на название файла фикстуры без расширения, которые находятся в корне каталога.
#### Шаг 6: Проверка работоспособности
#### Откройте браузер и перейдите на http://localhost:9052 для проверки работоспособности проекта.
